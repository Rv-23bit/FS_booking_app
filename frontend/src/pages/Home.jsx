...
const Home = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-20 text-center px-4">
      <h1 className="text-3xl font-bold mb-4">Welcome to FS Club</h1>
      <p className="text-gray-600 mb-8">
        Book fitness classes at our studio. Sign up as a member to view the
        schedule and reserve your spot.
      </p>
      <div className="flex justify-center gap-4">
        <Link to="/register" className="bg-brand text-white px-5 py-2 rounded">
          Sign up
        </Link>
        <Link to="/login" className="border border-brand text-brand px-5 py-2 rounded">
          Log in
        </Link>
      </div>
    </div>
